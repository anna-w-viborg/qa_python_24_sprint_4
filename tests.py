import pytest
from conftest.py import b_collector
...
class TestBooksCollector:
    ...
    # 1 f 1 test
    def test_add_new_book_add_two_books(self, b_collector):
        ...
        assert len(b_collector.get_books_genre()) == 2
    ...
    # 3 f 1 test
    def test_get_book_genre_show_genre(self, b_collector):
        b_collector.add_new_book("Ого")    # добавляем книгу
        b_collector.set_book_genre("Ого", "Ужасы")   # устанавливаем жанр
        assert b_collector.get_books_genre("Ого") == "Ужасы"   # получаем жанр книги по названию
    ...
    # 5 f 1 test
    def test_get_books_genre_show_list(self, b_collector):
        b_collector.add_new_book("Ого")  # добавляем книгу
        b_collector.set_book_genre("Ого", "Ужасы")  # устанавливаем жанр
        b_collector.add_new_book("Огров")  # добавляем книгу
        b_collector.set_book_genre("Огров", "Фантастика")  # устанавливаем жанр
    ...
    def test_add_book_in_favorites_show_books(self, b_collector):
        b_collector.add_new_book("Огров")  # добавляем книгу
        b_collector.add_book_in_favorites ("Огров") #
    ...
    def test_get_list_of_favorites_books(self, b_collector):
        b_collector.add_new_book("Ого")  # добавляем книгу
        b_collector.add_book_in_favorites("Ого")  # в избранные
        b_collector.add_new_book("Огров")  # добавляем книгу
        b_collector.add_book_in_favorites("Огров")  # в избранные
        b_collector.add_new_book("Гарри Поттер")  # добавляем книгу
        b_collector.add_book_in_favorites("Гарри Поттер")  # в избранные
        assert b_collector.get_list_of_favorites_books() == ["Ого", "Огров", "Гарри Поттер"]
